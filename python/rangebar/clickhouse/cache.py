...
class RangeBarCache(ClickHouseClientMixin, BulkStoreMixin, QueryOperationsMixin):
    ...
    # =========================================================================
    # Population Checkpoints (Issue #69: Cross-machine resume)
    # =========================================================================
    # These methods support resumable cache population with bar-level accuracy.
    # Checkpoints are stored both locally and in ClickHouse for hybrid storage.
