...
# Re-export CONTINUITY_TOLERANCE_PCT from constants (backward compatibility)
...
# Thin wrapper for internal use (delegates to extracted module)
_validate_junction_continuity = validate_junction_continuity
