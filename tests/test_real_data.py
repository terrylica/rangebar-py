...
class TestRealBinanceData:
    ...
    def test_process_binance_aggtrades(self):
        ...
        range_bars = process_trades_to_dataframe(df, threshold_decimal_bps=250)
        ...
        # No NaN values
        assert not range_bars.isna().any().any(), "Should have no NaN values"
    ...
    def test_multiple_threshold_values(self):
        ...
        assert (
            results[100] >= results[250] >= results[500] >= results[1000]
